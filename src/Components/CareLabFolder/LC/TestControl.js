import { Form, InputNumber, Button, Select, Row, Col, Switch, message } from 'antd';
import { useState, useEffect } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { useHistory } from 'react-router-dom';
import styled from 'styled-components';
import { useControlDetails } from '../../../CustomHook/useControlDetails';
import { getControlTestListApi, getListOfControlWiseSDApi, setControlWiseSDApi } from '../../../services/qcService';
...
const TestControl = (props) => {
    ...
    const [previousValues, setpreviousValues] = useState(forEdit ? category?.testcontrols[SId] : {})
    ...
    useEffect(() => {
        if (forEdit && previousValues === undefined) {
            ...
            dispatch(getListOfControlWiseSDApi(newD, (res) => {
