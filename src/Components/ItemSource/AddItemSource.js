import { Form, Input, Button, message, Row, Col, Switch, DatePicker } from 'antd';
import { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { useHistory } from 'react-router-dom';
import styled from 'styled-components';
import { getItemSourceDetApi, insertItemSourceDetApi } from '../../services/itemSourceService';
...
const AddItemSource = (props) => {
    ...
    const [previousValues, setPreviousValues] = useState(forEdit ? itemTypeReducer?.newItems[TId] : {});
    ...
    const onFinish = (values) => {
        ...
        dispatch(insertItemSourceDetApi(data, (res) => {
